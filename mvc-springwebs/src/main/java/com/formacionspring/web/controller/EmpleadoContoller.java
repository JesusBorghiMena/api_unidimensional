...
public class EmpleadoContoller {
	...
	public String listarEmpleados(Model modelo) {
		modelo.addAttribute("llave", servicio.listaEmpleado());
		return "empleado";
	/*Empleado emp = new Empleado();
		emp.setId(1);
		emp.setNombre("Cristiano");
		emp.setApellido("Ronaldo");
		emp.setEmail("elbico@gmail.com");
		emp.setTelefono(676543423);
		*/
	}
	...
	public String nuevoEmpleado(Model modelo) {
		//objeto empleado vacio se pasa a la vista nueva
		//esto para poder realizar el registro desde los imputs
		Empleado emp= new Empleado();
